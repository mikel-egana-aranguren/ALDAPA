...
public class ManagerTest {
	...
	@BeforeClass
	public static void setUpBeforeClass() throws AldapaException, IOException, ClassNotFoundException, InstantiationException, IllegalAccessException  {
	...
	public final void testAddNamedGraph() throws IOException, URISyntaxException, MethodNotSupportedException, AldapaException {
		...
		String named_graph_uri = manager.addNamedGraph(graphName, dataset_uri);
