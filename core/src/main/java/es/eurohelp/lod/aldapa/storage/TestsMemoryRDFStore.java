 ...
 *
 */
public class TestsMemoryRDFStore implements InitRDFStore {

	/**
	 * 
	 */

	private static final Logger LOGGER = LogManager.getLogger(TestsMemoryRDFStore.class);

	Repository repo;
	RepositoryConnection conn;

	public TestsMemoryRDFStore() {
